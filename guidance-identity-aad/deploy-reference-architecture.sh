...
VIRTUAL_NETWORK_DEPLOYMENT_NAME="ra-aad-ntier-vnet-deployment"
...
MGMT_TIER_DEPLOYMENT_NAME="ra-aad-ntier-mgmt-deployment"
...
NETWORK_SECURITY_GROUP_DEPLOYMENT_NAME="ra-aad-ntier-nsg-deployment"
